    ...
    >
      <div className="w-[100%] max-w-7xl sm:mx-auto flex flex-col items-center mx-2">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-8">
          {[
            {
              ...
              bg: "/Future-Proof-Architecture.png",
            },
            {
            ...
            <div
              key={i}
              className="rounded-[18px] min-w-[260px] max-w-[270px] mx-auto shadow-md flex flex-col items-center justify-end p-6 text-center"
              style={{
         ...
         <div className="relative xl:mx-auto mt-12 sm:mt-16 md:mt-20  text-center bg-[#AFCDFF63] rounded-[12px] mx-2 mx-2">
                <Image
                ...
                <div className="relative  backdrop-blur-md  shadow-md rounded-2xl px-4 sm:px-8 md:px-1 py-5 sm:py-2">
                  <p className="text-slate-800 text-sm sm:text-base md:text-lg leading-relaxed">
                     Airports choose AcuSky because it offers one software that simplifies operations, reduces costs, and grows as they do.
                  </p>
                </div>
              </div>
      </div>
