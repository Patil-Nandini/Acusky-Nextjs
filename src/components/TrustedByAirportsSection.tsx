...
export default function TrustSection() {
  ...
  const FEATURES: Feature[] = [
    {
      ...
      radius: isMd ? "50% 0 0 50%" : "50% 50% 14px 14px",
    },
    {
  ...
  return (
    <section className="w-full pb-12 px-3">
      ...
      <div
        className="w-[100%] flex flex-col grid grid-cols-1 xl:grid-cols-12 gap-8 xl:gap-12 2xl:gap-16 flex-col xl:flex-row items-center justify-center xl:items-start xl:justify-center"
        style={{ width: "100%", display: "flex" }}
      >
        <div className="xl:col-span-8 2xl:col-span-9">
          <div
            className="rounded-[24px] p-3 sm:p-4 shadow-[inset_0_0_15px_0_#0396FF40]  lg:max-w-[1000px] lg:max-h-[641px]"
          ...
          >
            <div
              ...
              style={{
                background: "linear-gradient(180deg, #1768B8 0%, #3B97DA 100%)",
              }}
            >
              <div
                className="relative mx-auto mt-5 sm:mt-8 h-auto w-[94%] sm:w-[85%] md:w-[78%] md:max-w-[512px] md:max-h-[341px] lg:max-w-[1000px] lg:max-h-[641px] "
                style={{
                  background: "#9EC3F0",
              ...
              >
                ...
                <div
                  className="
                    my-10 grid gap-4 sm:gap-5 md:gap-41 lg:gap-36  
                ...
                >
                  {FEATURES.map((f, i) => (
                    <div
                      key={i}
                      className="flex flex-col items-center justify-start text-center border border-black/5 w-full md:w-[160px] lg:w-[200px] max-w-[260px]"
                      style={{
                        background:
                          "linear-gradient(180deg, #FBFCFE 0%, #E1F3FF 100%)",
        ...
        {/* Testimonials */}
        <div className="xl:col-span-4 2xl:col-span-3 flex flex-col gap-6 sm:gap-8 xl:gap-8 w-[100%] xl:w-[18%] flex flex-col md:flex-row xl:flex-col">
